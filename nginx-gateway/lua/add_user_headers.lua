-- Add User Headers to Backend Requests
local cjson = require "cjson"

-- Get user info from nginx context (set by jwt_validate.lua)
...
-- Add user headers for backend services
...
-- Also add the original Authorization header
